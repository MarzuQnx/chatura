...
(function () {
  ...
  var repo = {
    ...
    getGallery: function() { return [
        { thumb: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=80', alt: 'Team Collaboration', labelBadge: { en: 'Team Collaboration', id: 'Kolaborasi Tim' }, hasSideAccent: true, hasBlendOverlay: false },
        { thumb: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=1200&q=80', alt: 'Corporate Meeting', labelBadge: { en: 'Corporate Meeting', id: 'Rapat Korporat' }, hasSideAccent: false, hasBlendOverlay: true },
        { thumb: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&w=1200&q=80', alt: 'Office Space', labelBadge: { en: 'Office Space', id: 'Ruang Kantor' }, hasSideAccent: false, hasBlendOverlay: false },
        { thumb: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=1200&q=80', alt: 'Team Brainstorming', labelBadge: { en: 'Team Brainstorming', id: 'Tukar Pikiran' }, hasSideAccent: false, hasBlendOverlay: true },
        { thumb: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=1200&q=80', alt: 'Professional Discussion', labelBadge: { en: 'Professional Discussion', id: 'Diskusi Profesional' }, hasSideAccent: true, hasBlendOverlay: false },
        { thumb: 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=1200&q=80', alt: 'Networking Event', labelBadge: { en: 'Networking Event', id: 'Acara Jaringan' }, hasSideAccent: false, hasBlendOverlay: true },
        { thumb: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=1200&q=80', alt: 'Strategy Session', labelBadge: { en: 'Strategy Session', id: 'Sesi Strategi' }, hasSideAccent: false, hasBlendOverlay: false },
        { thumb: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80', alt: 'Digital Analytics', labelBadge: { en: 'Digital Analytics', id: 'Analisis Digital' }, hasSideAccent: true, hasBlendOverlay: false },
        { thumb: 'https://images.unsplash.com/photo-1606857521015-7f9fcf423740?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1606857521015-7f9fcf423740?auto=format&fit=crop&w=1200&q=80', alt: 'Modern Workspace', labelBadge: { en: 'Modern Workspace', id: 'Ruang Kerja Modern' }, hasSideAccent: false, hasBlendOverlay: true },
        { thumb: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1200&q=80', alt: 'Corporate Architecture', labelBadge: { en: 'Corporate Architecture', id: 'Arsitektur Korporat' }, hasSideAccent: false, hasBlendOverlay: false },
        { thumb: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=1200&q=80', alt: 'Team Work', labelBadge: { en: 'Team Work', id: 'Team Work' }, hasSideAccent: true, hasBlendOverlay: false },
        { thumb: 'https://images.unsplash.com/photo-1431540015161-0bf868a2d407?auto=format&fit=crop&w=600&q=80', image: 'https://images.unsplash.com/photo-1431540015161-0bf868a2d407?auto=format&fit=crop&w=1200&q=80', alt: 'Business Meeting', labelBadge: { en: 'Business Meeting', id: 'Rapat Bisnis' }, hasSideAccent: false, hasBlendOverlay: true }
    ]; },
    getPrograms: function() { return [
        { image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=80', alt: 'Internship', labelBadge: { en: 'Internship', id: 'Internship' }, icon: 'graduation-cap', i18nTitle: 'career.internship_title', i18nDesc: 'career.internship_desc', bullets: ['career.internship_bullet_1', 'career.internship_bullet_2', 'career.internship_bullet_3'] },
        { image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=800&q=80', alt: 'Future Leaders', labelBadge: { en: 'Future Leaders', id: 'Future Leaders' }, icon: 'star', i18nTitle: 'career.leaders_title', i18nDesc: 'career.leaders_desc', bullets: ['career.leaders_bullet_1', 'career.leaders_bullet_2', 'career.leaders_bullet_3'] }
    ]; },
